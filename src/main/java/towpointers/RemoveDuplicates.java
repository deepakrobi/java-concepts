 ...
 * appears only once. The relative order of the elements should be kept the same and you should not use any extra space
...
public class RemoveDuplicates {
    ...
    @Test
    void test1(){
        //length is 4 as out put is : [2,3,6,9]
        Assertions.assertEquals(4,removeDuplicates(new int [] {2, 3, 3, 3, 6, 9, 9}));
    }
